...
class MyUpcomingCasesAndSubcaseDeadlineDashlet extends DashletGeneric {
	...
	function process($lvsParams3 = array()) {
		...
		$lvsParams3 = array(
						...
						'custom_where'=> ' AND c_s_d_case_subcase_dashlet.client_consultant_id = "'.$current_user->id.'" AND c_s_d_case_subcase_dashlet.due_date >= "'.$currentDate.'" AND jt6.order_no !="0" AND jt6.order_no !="100"',
