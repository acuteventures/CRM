...
// Date : 18-Jun-2012.
 ...
 where c_case_status.order_no >= 20 AND accounts.deleted = '0' AND cases.deleted = '0' AND c_case_status.deleted = '0') AND accounts.deleted = '0' AND cases.deleted = '0' AND c_case_status.deleted = '0' ";*/
			$ret_array['where'] = "  WHERE (c_case_status.order_no < 20 AND accounts.id not in (select accounts.id from accounts LEFT JOIN cases ON cases.account_id = accounts.id LEFT JOIN c_case_status ON cases.status = c_case_status.id
 where c_case_status.order_no >= 20 AND accounts.deleted = '0' AND cases.deleted = '0' AND c_case_status.deleted = '0') AND cases.deleted = '0' AND c_case_status.deleted = '0') || (accounts.id not in(select cases.account_id from cases where cases.deleted = '0')) AND accounts.deleted = '0' ";
