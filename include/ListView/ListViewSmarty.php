...
class ListViewSmarty extends ListViewDisplay{
	...
	function process($file, $data, $htmlVar) {
		...
		// adding email button in cases module
		if($_REQUEST['module'] == 'Cases' || $_REQUEST['module'] == 'c_s_d_case_subcase_dashlet')
		{
			$email_button = '<input type="button" name="Email" id="Email" value="Email" onclick="return sListView.send_form_for_emails_listview(true, \''.$_REQUEST['module'].'\', \'index.php?module='.$_REQUEST['module'].'&action=EmailView\',\''.$app_strings['LBL_LISTVIEW_NO_SELECTED'].'\', \''.$_REQUEST['module'].'\', \'100\', \''.$app_strings['LBL_LISTVIEW_LESS_THAN_TEN_SELECT'].'\')">';
			$this->ss->assign('emailbutton', $email_button);
		}
		//End
