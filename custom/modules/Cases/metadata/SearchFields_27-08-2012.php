...
$searchFields['Cases'] = 
    array (
		...
		'name' => array('query_type'=> 'default','db_field'=>array('(REPLACE(REPLACE(cases.name," ",""),"","-")) ')),
	    ...
	    //Range Search Support
		//by anuradha 07-02-2012
		'patent_number' => array( 'query_type'=>'default'),
		'application_number' => array( 'query_type'=>'default'),
		'tm_application_number' => array( 'query_type'=>'default'),
		'tm_registration_number' => array( 'query_type'=>'default'),
		//end
