...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='accountfilter_basic'> {sugar_translate label='LBL_ACC_FILTER' module='Accounts'}
		</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{html_options id='accountfilter_basic' name='accountfilter_basic[]' options=$fields.accountfilter_basic.options size="1" style="width: 150px"  selected=$fields.accountfilter_basic.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='viewasfilter_basic' >{sugar_translate label='LBL_VIEWAS_FILTER' module='Accounts'}</label>
    	</td>
