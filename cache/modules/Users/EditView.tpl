...
<label for="user_name">{$label|strip_semicolon}:</label>
...
<label for="UserType">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="employee_status">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="show_on_employees">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="reports_to_name">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="phone_other">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="phone_home">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="messenger_type">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="messenger_id">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="address_street">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="address_city">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="address_state">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="address_postalcode">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
...
<label for="address_country">{$label|strip_semicolon}:</label>
</td>
{counter name="fieldsUsed"}
