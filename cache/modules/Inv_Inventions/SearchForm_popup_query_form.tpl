...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'>{sugar_translate label='LBL_NAME' module='Inv_Inventions'}</label>
		</td>
...
<input type='text' name='{$fields.name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='inv_inventions_accounts_name_advanced'>{sugar_translate label='LBL_INV_INVENTIONS_ACCOUNTS_FROM_ACCOUNTS_TITLE' module='Inv_Inventions'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="{$fields.inv_inventions_accounts_name_advanced.name}"  class="sqsEnabled"   id="{$fields.inv_inventions_accounts_name_advanced.name}" size="" value="{$fields.inv_inventions_accounts_name_advanced.value}" title='' autocomplete="off" READONLY >
<input type="hidden"  id="{$fields.inv_inventd1acccounts_ida_advanced.name}" value="{$fields.inv_inventd1acccounts_ida_advanced.value}">
<span class="id-ff multiple">
<button type="button" name="btn_clr_{$fields.inv_inventions_accounts_name_advanced.name}"   title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button" onclick="this.form.{$fields.inv_inventions_accounts_name_advanced.name}.value = ''; this.form.{$fields.inv_inventd1acccounts_ida_advanced.name}.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}">{sugar_getimage name="id-ff-clear" alt=$app_strings.LBL_ID_FF_CLEAR ext=".png" other_attributes=''}</button>
</span>
