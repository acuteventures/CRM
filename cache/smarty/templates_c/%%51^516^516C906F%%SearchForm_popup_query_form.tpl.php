...
></div>',CLOSETITLE, SUGAR.language.get('app_strings', 'LBL_SEARCH_HELP_CLOSE_TOOLTIP'), CLOSECLICK,FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass');" class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Inv_Inventions'), $this);?>
</label>
		</td>
...
></div>',CLOSETITLE, SUGAR.language.get('app_strings', 'LBL_SEARCH_HELP_CLOSE_TOOLTIP'), CLOSECLICK,FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass');" class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='inv_inventions_accounts_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_INV_INVENTIONS_ACCOUNTS_FROM_ACCOUNTS_TITLE','module' => 'Inv_Inventions'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['inv_inventions_accounts_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['inv_inventions_accounts_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['inv_inventions_accounts_name_advanced']['value']; ?>
" title='' autocomplete="off" READONLY >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['inv_inventd1acccounts_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['inv_inventd1acccounts_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['inv_inventions_accounts_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button" onclick="this.form.<?php echo $this->_tpl_vars['fields']['inv_inventions_accounts_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['inv_inventd1acccounts_ida_advanced']['name']; ?>
