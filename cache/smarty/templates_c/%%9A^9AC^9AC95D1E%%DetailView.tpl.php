<?php /* Smarty version 2.6.11, created on 2012-08-27 18:48:38
         compiled from cache/modules/trade_trademark/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/trade_trademark/DetailView.tpl', 29, false),array('function', 'counter', 'cache/modules/trade_trademark/DetailView.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/trade_trademark/DetailView.tpl', 43, false),array('function', 'sugar_ajax_url', 'cache/modules/trade_trademark/DetailView.tpl', 109, false),array('function', 'sugar_getjspath', 'cache/modules/trade_trademark/DetailView.tpl', 228, false),array('modifier', 'strip_semicolon', 'cache/modules/trade_trademark/DetailView.tpl', 44, false),array('modifier', 'escape', 'cache/modules/trade_trademark/DetailView.tpl', 93, false),array('modifier', 'url2html', 'cache/modules/trade_trademark/DetailView.tpl', 93, false),array('modifier', 'nl2br', 'cache/modules/trade_trademark/DetailView.tpl', 93, false),)), $this); ?>
...
" class="button primary" onclick="this.form.return_module.value='trade_trademark'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='trade_trademark'; this.form.return_action.value='DetailView'; this.form.isDuplicate.value=true; this.form.action.value='EditView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
" class="button" onclick="this.form.return_module.value='trade_trademark'; this.form.return_action.value='ListView'; this.form.action.value='Delete'; return confirm('<?php echo $this->_tpl_vars['APP']['NTC_DELETE_CONFIRMATION']; ?>
...
" class="button" onclick="this.form.return_module.value='trade_trademark'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<?php if (! $this->_tpl_vars['fields']['name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'trade_trademark'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['assigned_user_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'trade_trademark'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['description']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'trade_trademark'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['trade_trademark_accounts_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_TRADE_TRADEMARK_ACCOUNTS_FROM_ACCOUNTS_TITLE','module' => 'trade_trademark'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['trade_trademark_accounts_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['trade_trademark_accountsaccounts_ida']['value'] )):  ob_start(); ?>index.php?module=Accounts&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['trade_trademark_accountsaccounts_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="trade_trademark_accountsaccounts_ida" class="sugar_field"><?php echo $this->_tpl_vars['fields']['trade_trademark_accounts_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['trade_trademark_accountsaccounts_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['date_entered']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ENTERED','module' => 'trade_trademark'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LINEITEMS_PANEL','module' => 'trade_trademark'), $this);?>
</h4>
...
<span id="" class="sugar_field"><?php echo $this->_tpl_vars['LINEITEMS_ROWS']; ?>
</span>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
">
<tr>
<td scope="row" align="left" colspan="7"><h4><?php echo $this->_tpl_vars['TRADEMARK_HISTORY']; ?>
</h4></td>
<td></td>
</tr>
<tr>
...
<script type="text/javascript" src="<?php echo smarty_function_sugar_getjspath(array('file' => "custom/modules/trade_trademark/trademark_history.js"), $this);?>
"></script>