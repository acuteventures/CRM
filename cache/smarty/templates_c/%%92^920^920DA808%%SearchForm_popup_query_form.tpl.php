<?php /* Smarty version 2.6.11, created on 2012-08-27 11:12:53
         compiled from cache/modules/Cases/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 6, false),array('function', 'math', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 7, false),array('function', 'sugar_getimagepath', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 15, false),array('function', 'sugar_translate', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 24, false),array('function', 'sugar_getimage', 'cache/modules/Cases/SearchForm_popup_query_form.tpl', 67, false),)), $this); ?>
...
></div>',CLOSETITLE, SUGAR.language.get('app_strings', 'LBL_SEARCH_HELP_CLOSE_TOOLTIP'), CLOSECLICK,FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass');" class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
		...
		<label for='invention_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_INVENTION_NAME','module' => 'Cases'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['invention_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['invention_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['invention_name_advanced']['value']; ?>
" title='' autocomplete="off"  >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['invention_id_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['invention_id_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['invention_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button" onclick="this.form.<?php echo $this->_tpl_vars['fields']['invention_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['invention_id_advanced']['name']; ?>
...
">
<span class="id-ff multiple">
<button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['account_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button" onclick="this.form.<?php echo $this->_tpl_vars['fields']['account_name_advanced']['name']; ?>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'popup_query_form_modified_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_advanced","modified_user_id_advanced"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_created_by_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_advanced","created_by_advanced"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_assigned_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_advanced","assigned_user_id_advanced"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_user_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["user_name_advanced","client_consultant_id_advanced"],"required_list":["client_consultant_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_client_consultant_name_advanced\']={"form":"popup_query_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["client_consultant_name_advanced","client_consultant_id_advanced"],"required_list":["client_consultant_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_type_name_advanced\']={"form":"popup_query_form","method":"query","modules":["c_case_type"],"group":"or","field_list":["name","id"],"populate_list":["type_name_advanced","type_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_status_name_advanced\']={"form":"popup_query_form","method":"query","modules":["c_case_status"],"group":"or","field_list":["name","id"],"populate_list":["status_name_advanced","status_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_invention_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Inv_Inventions"],"group":"or","field_list":["name","id"],"populate_list":["invention_name_advanced","invention_id_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_account_name_advanced\']={"form":"popup_query_form","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["popup_query_form_account_name_advanced","account_id_advanced"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"required_list":["account_id"],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'popup_query_form_trade_trademark_cases_name_advanced\']={"form":"popup_query_form","method":"query","modules":["trade_trademark"],"group":"or","field_list":["name","id"],"populate_list":["trade_trademark_cases_name_advanced","trade_trademark_casestrade_trademark_ida_advanced"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>