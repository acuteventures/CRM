<?php /* Smarty version 2.6.11, created on 2012-09-04 18:33:44
         compiled from cache/modules/trade_trademark/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/trade_trademark/SearchForm_popup_query_form.tpl', 6, false),array('function', 'math', 'cache/modules/trade_trademark/SearchForm_popup_query_form.tpl', 7, false),array('function', 'sugar_getimagepath', 'cache/modules/trade_trademark/SearchForm_popup_query_form.tpl', 15, false),array('function', 'sugar_translate', 'cache/modules/trade_trademark/SearchForm_popup_query_form.tpl', 24, false),array('function', 'sugar_getimage', 'cache/modules/trade_trademark/SearchForm_popup_query_form.tpl', 66, false),)), $this); ?>
...
></div>',CLOSETITLE, SUGAR.language.get('app_strings', 'LBL_SEARCH_HELP_CLOSE_TOOLTIP'), CLOSECLICK,FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass');" class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'trade_trademark'), $this);?>
</label>
		</td>
...
></div>',CLOSETITLE, SUGAR.language.get('app_strings', 'LBL_SEARCH_HELP_CLOSE_TOOLTIP'), CLOSECLICK,FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass');" class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='trade_trademark_accounts_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TRADE_TRADEMARK_ACCOUNTS_FROM_ACCOUNTS_TITLE','module' => 'trade_trademark'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<input type="text" name="<?php echo $this->_tpl_vars['fields']['trade_trademark_accounts_name_advanced']['name']; ?>
"  class="sqsEnabled"   id="<?php echo $this->_tpl_vars['fields']['trade_trademark_accounts_name_advanced']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['trade_trademark_accounts_name_advanced']['value']; ?>
" title='' autocomplete="off" READONLY >
<input type="hidden"  id="<?php echo $this->_tpl_vars['fields']['trade_trademark_accountsaccounts_ida_advanced']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['trade_trademark_accountsaccounts_ida_advanced']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['trade_trademark_accounts_name_advanced']['name']; ?>
"   title="<?php echo $this->_tpl_vars['APP']['LBL_CLEAR_BUTTON_TITLE']; ?>
" class="button" onclick="this.form.<?php echo $this->_tpl_vars['fields']['trade_trademark_accounts_name_advanced']['name']; ?>
.value = ''; this.form.<?php echo $this->_tpl_vars['fields']['trade_trademark_accountsaccounts_ida_advanced']['name']; ?>
