<?php /* Smarty version 2.6.11, created on 2012-09-04 14:16:06
         compiled from cache/modules/Accounts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/DetailView.tpl', 29, false),array('function', 'counter', 'cache/modules/Accounts/DetailView.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/Accounts/DetailView.tpl', 35, false),array('function', 'sugar_getjspath', 'cache/modules/Accounts/DetailView.tpl', 59, false),array('function', 'sugar_phone', 'cache/modules/Accounts/DetailView.tpl', 356, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/DetailView.tpl', 45, false),array('modifier', 'substr', 'cache/modules/Accounts/DetailView.tpl', 190, false),array('modifier', 'to_url', 'cache/modules/Accounts/DetailView.tpl', 192, false),array('modifier', 'escape', 'cache/modules/Accounts/DetailView.tpl', 241, false),array('modifier', 'url2html', 'cache/modules/Accounts/DetailView.tpl', 241, false),array('modifier', 'nl2br', 'cache/modules/Accounts/DetailView.tpl', 241, false),array('modifier', 'strip_tags', 'cache/modules/Accounts/DetailView.tpl', 247, false),)), $this); ?>
...
" class="button" onclick="this.form.return_module.value='Accounts'; this.form.return_action.value='DetailView'; this.form.return_id.value='<?php echo $this->_tpl_vars['id']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['client_source']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CLIENT_SOURCE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['client_source']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['client_source']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['client_source']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['client_source']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['client_source']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['client_source']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['client_source']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['client_source']['options'][$this->_tpl_vars['fields']['client_source']['value']]; ?>
...
<td width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PHONE_NOS','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<td width='37.5%'  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>

<span id="" class="sugar_field"><?php echo $this->_tpl_vars['PHONE_NOS']; ?>
</span>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['id']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CLIENT_ID','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['id']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>

<span id="id" class="sugar_field"><?php echo $this->_tpl_vars['CLIENT_ID']; ?>
</span>
<?php endif; ?>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['password']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_PASSWORD','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['password']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['LBL_PASSWORD']['hidden']): ?>
&nbsp;
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['LBL_PASSWORD']['hidden']):  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_CLIENT_RECORD_DISPLAY','module' => 'Accounts'), $this);?>
</h4>
...
<span id="" class="sugar_field"><?php echo $this->_tpl_vars['CLIENT_RECORD_DISPLAY']; ?>
</span>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_TRADEMARK_RECORD_DISPLAY','module' => 'Accounts'), $this);?>
</h4>
...
<span id="" class="sugar_field"><?php echo $this->_tpl_vars['CLIENT_TRADEMARK_RECORD_DISPLAY']; ?>
</span>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
<h4><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PANEL_OTHERS_DISPLAY','module' => 'Accounts'), $this);?>
</h4>
...
<span id="" class="sugar_field"><?php echo $this->_tpl_vars['CLIENT_OTHERS_RECORD_DISPLAY']; ?>
</span>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
...
">
<tr>
<td scope="row" align="left" colspan="7"><h4><?php echo $this->_tpl_vars['CLIENT_HISTORY']; ?>
</h4></td>
<td></td>
</tr>
<tr>
...
<script type="text/javascript" src="<?php echo smarty_function_sugar_getjspath(array('file' => "custom/modules/Accounts/client_history.js"), $this);?>
"></script>