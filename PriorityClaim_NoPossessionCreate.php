...
*****************************************************************************/
	...
	if(isset($_REQUEST['btn_claim'])){
		...
		echo "<script language  = 'javascript'>
				function saveId(){
					//window.opener.document.getElementById('clm_np_ids').value = '';
					window.opener.document.getElementById('clm_np_ids').value +=' $cs_no_ids';
				}
			</script>";
...
<form action="" method="post">
		...
		<table class="edit view">
			...
			<tr>
				...
				<!--<img border="0" src="themes/Sugar5/images/jscalendar.gif?s=56edbfd31f58ddaef7105e2f7049754f&c=1" alt="Enter Date" id="created_trigger" align="absmiddle" />--></td>
			</tr>
		</table>	
